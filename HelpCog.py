...
""", color=config.color)
    ...
    self.embed.add_field(
        name="Main",
        value=f"**<:automod:1186261370946191491> : Auto Moderation\n<:moderation:1186261576047661056> : Moderation\n🥳 : Giveaway\n🎫 : Ticket\n🔦 : Utility\n👋 : Welcome**"
    )
    self.embed.add_field(
        name="Extra",
        value=f"**<:raze_responder:1186263442257084509> : Auto Responder\n<:logging:1186263516815040543> : Logging\n📱 : Media\n<:vc:1186263655487119412> : Voice Command\n🏸 : Fun\n<a:botdev:1186264139019075666> : Bot**"
    )
